//////////////////////////////////////////////////////////////////////////////////
////////////////////FibrilToolBatch from segmented cells//////////////////////////
////////////////////////Marion Louveaux, PhD student//////////////////////////////
/////////////////////////Stephane Verger, Post Doc////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////

//This macro is an automated version of FibrilTool macro, developped by Arezki Boudaoud (see 2014, Boudaoud, Nature Protocols), which has been further modified to be used after the macro_Seg_forFTBatch.ijm macro that allows a semi automatic creation of the ROIset from an image of the cell contours.
//FibrilTool is executed on each .roi of the RoiSet, and for each RoiSet of the directory that you will select when running the macro;
//As an output, it creates a text file containing the FibrilTool output (MTs angles, anisotropy,...), and an image of the MTs with the fibriltool line output overlaid.
